...
export default function Expenses() {
    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="card" style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                ...
                <div style={{ flex: '1 1 120px', borderLeft: '1px solid var(--border-color)', paddingLeft: '1rem' }}>
